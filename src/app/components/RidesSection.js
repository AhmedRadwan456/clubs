  ...
  const dict = {
    ar: {
      ...
      rides: [
        ...
        { emoji: "👓", name: "سينما 9D التفاعلية", desc: "تجربة واقع افتراضي مبهرة مع حركة، هواء، ومؤثرات حقيقية", tag: "تكنولوجيا", tagColor: "bg-purple-100 text-purple-600", paid: true },
        ...
        { emoji: "👻", name: "بيت الرعب الحقيقي", desc: "رحلة مرعبة داخل قصر مظلم مليء بالممثلين الحقيقيين والمفاجآت", tag: "Horror", tagColor: "bg-slate-100 text-slate-800", paid: true },
        { emoji: "🎢", name: "الأفعونية الفائقة", desc: "أسرع أفعونية في الشرق الأوسط — تصل إلى 120 كم/س بانقلابات مذهلة", tag: "Extreme", tagColor: "bg-red-100 text-red-600", paid: false },
    ...
    en: {
      ...
      rides: [
        ...
        { emoji: "👓", name: "Interactive 9D Cinema", desc: "A stunning VR experience with motion, wind, and hyper-realistic effects.", tag: "Tech", tagColor: "bg-purple-100 text-purple-600", paid: true },
        ...
        { emoji: "👻", name: "Real Haunted House", desc: "A terrifying journey inside a dark mansion filled with live actors and scares.", tag: "Horror", tagColor: "bg-slate-100 text-slate-800", paid: true },
        { emoji: "🎢", name: "Hyper Coaster", desc: "The fastest rollercoaster in the Middle East — up to 120 km/h with mind-blowing loops.", tag: "Extreme", tagColor: "bg-red-100 text-red-600", paid: false },
